...
public class SwerveDriveCommand extends Command {
    ...
    private final DoubleSupplier linearMagnitudeScalingFactor;

    /**
     * Create a new command to drive a serve robot.
     * 
     * @param driveBase                    The {@link DriveBase} to drive.
     * @param strafeXSupplier              Supplier for strafe in X direction, e.g.
     *                                     from a joystick.
     * @param strafeYSupplier              Supplier for strafe in Y direction, e.g.
     *                                     from a joystick.
     * @param rotationSupplier             Supplier for rotation, e.g. from a
     *                                     joystick.
     * @param fieldCentric                 Supplier for whether or not to drive
     *                                     field centric.
     * @param squareInputs                 If true, square the linear magnitude of
     *                                     the strafe suppliers combined and that of
     *                                     the rotation, but keeps direction the
     *                                     same.
     * @param linearMagnitudeScalingFactor Supplier for a scaling factor for the
     *                                     linear magnitude.
     */
    public SwerveDriveCommand(DriveBase driveBase, DoubleSupplier strafeXSupplier, DoubleSupplier strafeYSupplier,
            ...
            DoubleSupplier linearMagnitudeScalingFactor) {
        ...
        this.linearMagnitudeScalingFactor = linearMagnitudeScalingFactor;
    ...
    public SwerveDriveCommand(DriveBase driveBase, double strafeX, double strafeY, double rotation,
        ...
        this(driveBase, () -> strafeX, () -> strafeY, () -> rotation, () -> fieldCentric, squareInputs, () -> 1);
    }
    ...
    public void execute() {
        if (fieldCentric.getAsBoolean()) {
            ...
            linearMagnitude *= linearMagnitudeScalingFactor.getAsDouble();
